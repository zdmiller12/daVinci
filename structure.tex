...
\graphicspath{{Media/Pictures/}{Media/Figures/}{Media/Pictures/ChapterHeadings/}} % Specifies the directory where pictures are stored
...
%%----------------------------------------------------------------------------------------
% i added for appendix labeling
\usepackage[title]{appendix}
% removed backref=true
\usepackage[style=numeric,citestyle=numeric,sorting=nyt,sortcites=true,autopunct=true,autolang=hyphen,hyperref=true,abbreviate=false,backend=biber]{biblatex}
...
\usepackage{autonum}
% below to reference labels from main document from Solution Manual
\usepackage{xr} 
\usepackage{bookmark}
\bookmarksetup{
open,
